...
from polls.viewsets.choice_viewsets import ChoiceList, ChoiceEdit, ChoiceDelete
from polls.viewsets.vote_viewsets import CreateVote
...
#     path("choices/", ChoiceList.as_view(), name="choice_list"),
    ...
    path('choice/<int:pk>/<int:poll_id>/',
         ChoiceDelete.as_view(), name='choice_delete'),
    path('choice-edit/<int:pk>/<int:poll_id>/',
         ChoiceEdit.as_view(), name='choice_edit')
